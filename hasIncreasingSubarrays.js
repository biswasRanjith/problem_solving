...
console.log(hasIncreasingSubarrays([1,2,3,4,5,6], 3)); // Output: true
console.log(hasIncreasingSubarrays([1,3,5,7,9,2,4,6,8,10], 4)); // Output: true
console.log(hasIncreasingSubarrays([5,4,3,2,1], 2)); 