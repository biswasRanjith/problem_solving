...
// Example usage:
console.log(maxPartitionsAfterOperations("accca", 2)); // Output: 3
console.log(maxPartitionsAfterOperations("aabaab", 3)); // Output: 1
console.log(maxPartitionsAfterOperations("xxyz", 1)); // Output: 4